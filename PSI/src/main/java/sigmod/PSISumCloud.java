...
public class PSISumCloud {
    ...
    public PSISumCloud(int numOwners, int delta, int eta, int g, int eta2, int numRows, int numThreads) {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        PSISumCloud psiCloud = new PSISumCloud(
