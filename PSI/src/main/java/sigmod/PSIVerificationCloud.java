...
public class PSIVerificationCloud {
    ...
    public PSIVerificationCloud(int numOwners, int delta, int eta, int g, int eta2, int numRows, int numThreads) {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        PSIVerificationCloud psiCloud = new PSIVerificationCloud(
